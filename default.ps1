...
Task Print-TaskList -depends Print-Banner {
	...
	Write-Host -ForegroundColor Green "Build-Solution"-nonewline; write-host " : Build Project (4.6)"
	Write-Host -ForegroundColor Green "Build-Project"-nonewline; write-host " : Build Project (4.6)"
	Write-Host -ForegroundColor Green "Build-Project-Net46"-nonewline; write-host " : Build Project (4.6)"
	Write-Host -ForegroundColor Green "Test-Project" -nonewline; write-host " : Test Project (v4.6)"
...
Task Build-Project -depends Build-Project-Net46 {
}

Task Build-Project-Net46 {
...
Task Test-Project -depends Test-Project-Net46 {
}

Task Test-Project-Net46 -depends Build-Test-Project-Net46 {
	$version = "v4.6"
	$configuration = $script:hash.build_mode
...
Task Create-NugetPackage  -depends Build-Project-Net46, Build-Project-Net40 { 
